...
class homeControllers {
    ...
    submit_review = async (req, res) => {
        ...
        console.log(`Received review data: Name=${name}, Rating=${rating}, Review=${review}, ProductId=${productId}`);
        ...
        try {
            ...
            console.log(`Review submitted successfully for ProductId=${productId}. New average rating: ${productRating}`);
    
            res.status(201).json({ message: "Review submitted successfully", productRating });
        } catch (error) {
